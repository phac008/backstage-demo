...
Fork the following repo `https://github.com/phac008/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/phac008/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/phac008/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster1.mcp.pitagora.at/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/phac008/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/phac008/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/phac008/backstage-app-demo` to your organization.
